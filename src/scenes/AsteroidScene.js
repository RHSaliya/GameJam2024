...
export default class HelloWorldScene extends Phaser.Scene {
	...
	create() {
        ...
        this.asteroid1 = this.add.image(300 - 50, 300 / 2, "asteroid1");
        this.asteroid2 = this.add.image(600, 600 / 2, "asteroid2");
        this.asteroid3 = this.add.image(900 / 2 + 50, 900 / 2, "asteroid3");
